...
public class RefinedOrderingRelationsMatrix {
    ...
    public ProperCompletePrefixUnfolding getCPU()
    {
    	return this._cpu;
    }
    ...
    public RefinedOrderingRelationsMatrix(NetSystem sys, boolean extend) {
        ...
        //this._cpu.makeTAR();
        Hashtable<String,Set<String>> pureTARs = this._cpu.makePureTAR();
        
        this.tarTime = System.nanoTime() - start;
        /*
        start = System.nanoTime();
    ...
    public int mapEventToIndex(Event e)
    {
        List<Transition> alObTransitions = new ArrayList<>(this._sys.getObservableTransitions());
    	return alObTransitions.indexOf(e.getTransition());
    }
