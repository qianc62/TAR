...
public abstract class AbstractBranchingProcess<BPN extends IBPNode<N>, C extends ICondition<BPN, C, E, F, N, P, T, M>, E extends IEvent<BPN, C, E, F, N, P, T, M>, F extends IFlow<N>, N extends INode, P extends IPlace, T extends ITransition, M extends IMarking<F, N, P, T>>
    ...
    // tar: maps event of unfolding to a set of succeeding events
    // added by jisheng 15/08/09
    protected Map<E, Set<E>> tar = null;
    ...
    /*
     * Added by Jisheng
     * Getting SEQUENTIAL TAR relation type of two events
     * True: is sequential tar
     * False: is not sequential tar
     */
    public boolean isSequentialTar(E e1, E e2) {
    	
    	if (this.tar.get(e1) == null) return false;
    	
    	if (this.tar.get(e1).contains(e2)) return true;
    	else
    		return false;
    }
